...
namespace RepuestosServicio.Models
{
    ...
    public partial class DBRepuestosEntities : DbContext
    {
        public DBRepuestosEntities()
            : base("name=DBRepuestosEntities")
        {
        }
        ...
        public virtual DbSet<Cilindraje> Cilindraje { get; set; }
